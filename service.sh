...
# Update main scripts
_wget -O "${MODPATH}/system/bin/XNET" "https://raw.githubusercontent.com/UsiFX/ThermodX-Source/main/system/bin/XNET"
_wget -O "${MODPATH}/system/bin/XPERF" "https://raw.githubusercontent.com/UsiFX/ThermodX-Source/main/system/bin/XPERF"
_wget -O "${MODPATH}/module.prop" "https://raw.githubusercontent.com/UsiFX/ThermodX-Source/main/module.prop"
_wget -O "${MODPATH}/system.prop" "https://raw.githubusercontent.com/UsiFX/ThermodX-Source/main/system.prop"
_wget -O "${MODPATH}/ThermodXbanner" "https://raw.githubusercontent.com/UsiFX/ThermodX-Source/main/ThermodXbanner"
